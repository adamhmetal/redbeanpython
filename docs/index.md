...
We do not need this information now, but it might be helpful later. (See section: [hybrid mode](hybrid_mode.md))
...
We can freely mix both ORMs in the same code base. This is a [**hybrid mode**](hybrid_mode.md).
